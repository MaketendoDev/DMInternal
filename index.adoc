++++
<div style="background-color: black; width: 100%; height: 50px; position: fixed; top: 0; left: 0; z-index: 1000;">
</div>
<div style="display: flex; align-items: center; justify-content: center; height: 100vh; margin: 0;">
    <img src="image/wiki_logo.png" alt="Dalek Mod 1.21.3 Internal Wiki" style="max-width: 50%; max-height: 50%; object-fit: contain;">
</div>
++++
