++++
<div style="background-color: #333333; width: 100%; height: 50px; position: fixed; top: 0; left: 0; z-index: 1000;">
</div>

<div style="position: fixed; top: -50px; left: 50%; transform: translateY(-200%); z-index: 1001;">
    <img src="images/wiki_logo.png" alt="Dalek Mod 1.21.3 Internal Wiki" style="max-height: 1750px; width: auto;">
</div>
