++++
<div style="background-color: #333333; width: 100%; height: 10px; position: fixed; top: 0; left: 0; z-index: 1000; display: flex; align-items: center; justify-content: center;">
    <img src="images/wiki_logo.png" alt="Dalek Mod 1.21.3 Internal Wiki" style="height: 300px;">
</div>
