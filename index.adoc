++++
<div style="background-color: #333333; width: 100%; height: 50px; position: fixed; top: 0; left: 0; z-index: 1000; display: flex; align-items: flex-end; justify-content: center; padding-bottom: 110px;">
    <img src="images/wiki_logo.png" alt="Dalek Mod 1.21.3 Internal Wiki" style="height: 100px; object-fit: contain;">
</div>
++++
