...
<div style="position: fixed; top: -50px; left: 50%; transform: translateX(-50%); z-index: 1001;">
    <img src="images/title_logo.png" alt="Dalek Mod 1.21.3 Internal Wiki" style="max-height: 150px; width: auto;">
</div>
